...
public class CartServiceImpl implements CartService {
    ...
    public CartItemVo addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StringUtils.isEmpty(productRedisValue)) {
            ...
            //cartOps是根据指定用户k1获取到了购物车，购物车的结构是Map<String k1,Map<String k2,CartItemInfo>>
    ...
    /**
     * 获取到我们要操作的购物车 cartOps是根据指定用户k1获取到了购物车里面的Map，购物车的结构是Map<String k1,Map<String k2,CartItemInfo>>
     * @return
     */
    ...
    private List<CartItemVo> getCartItems(String cartKey) {
        //获取购物车里面的所有商品
        BoundHashOperations<String, Object, Object> operations = redisTemplate.boundHashOps(cartKey);
        List<Object> values = operations.values();//获取cartKey所对应的键值对中的值
